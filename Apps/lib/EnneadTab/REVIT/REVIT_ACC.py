...
1. PROJECT DETAILS (get_acc_projects_data):
   ...
   - Cached as: CACHE_ACC_PROJECTS_DETAILS
...
2. PROJECT SUMMARY (get_ACC_summary_data):
   ...
   - Cached as: CACHE_ACC_PROJECTS_SUMMARY
...
3. PROJECT BY YEAR (generated alongside summary):
   ...
   - Cached as: CACHE_ACC_PROJECTS_BY_YEAR
...
CACHE_ACC_PROJECT_REVIT_FILES_TEMPLATE = "ACC_PROJECT_REVIT_FILES_{project_name}_{hub_name}"
CACHE_ACC_PROJECT_REVIT_FILES_ID_TEMPLATE = "ACC_PROJECT_REVIT_FILES_{project_id}_{hub_id}"
...
def get_acc_projects_data(use_record = True):
    ...
    Cache Location: CACHE_ACC_PROJECTS_DETAILS (shared dump folder)
...
def get_ACC_summary_data(show_progress = False):
    ...
    Cache Locations: 
    - CACHE_ACC_PROJECTS_SUMMARY (shared dump folder)
    - CACHE_ACC_PROJECTS_BY_YEAR (shared dump folder)
...
class ACC_PROJECT_RUNNER:
    ...
    def run_an_idle_job(self, year_version = None, debug = False):
        ...
        - Project summary data (CACHE_ACC_PROJECTS_SUMMARY)
